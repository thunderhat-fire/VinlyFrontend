  ...
  return (
    <>
      ...
      <div className="press-vinyl-container">
        ...
        <p>
          Choose your desired record release number and set up a crowdfunding project.
          We handle the rest: Pressing | Packaging | Distribution.
          It's easy & great value. If you don't reach your crowdfunding target, all your donors are refunded their money (terms and conditions apply).
        </p>
